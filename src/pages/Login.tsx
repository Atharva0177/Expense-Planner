    ...
    <div className="min-h-screen bg-[#FCFAF7] dark:bg-[#121212] text-[#1A1A1A] dark:text-[#F0ECE1] font-sans flex flex-col items-center justify-center p-4 sm:p-6 md:p-10 border-0 sm:border-[6px] md:border-[12px] border-white dark:border-[#1E1E1E] shadow-inner transition-colors">
      ...
      <div className="max-w-md w-full bg-white dark:bg-[#1A1A1A] border border-[#1A1A1A] dark:border-[#383838] shadow-[4px_4px_0px_#1A1A1A] sm:shadow-[8px_8px_0px_#1A1A1A] dark:shadow-[8px_8px_0px_#000] p-6 sm:p-8 md:p-10">
        <div className="text-center mb-8 border-b-2 border-[#1A1A1A] dark:border-[#383838] pb-6">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-serif italic font-light tracking-tight text-[#1A1A1A] dark:text-[#F0ECE1]">Expense Planner</h1>
          <p className="text-[10px] uppercase tracking-[0.25em] font-bold mt-3 text-[#555] dark:text-[#A0A0A0]">Personal & Household Finance</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
          <div>
            <label className="block text-[10px] uppercase font-bold tracking-widest text-[#1A1A1A] dark:text-[#E0E0E0] mb-1.5">Email</label>
            <input 
              type="email" 
              value={email}
          ...
          <div>
            <div className="flex justify-between items-end mb-1.5">
              <label className="block text-[10px] uppercase font-bold tracking-widest text-[#1A1A1A] dark:text-[#E0E0E0]">Password</label>
              {!isRegister && (
                <button 
                  type="button" 
