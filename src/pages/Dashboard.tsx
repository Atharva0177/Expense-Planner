      ...
      <header className="flex flex-col md:flex-row justify-between items-start md:items-end border-b-2 border-[#1A1A1A] dark:border-[#383838] pb-4 mb-4 sm:mb-6 md:mb-8 shrink-0 gap-4 sm:gap-6">
        <div>
          <div className="flex items-center gap-3">
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-serif italic font-light tracking-tight text-[#1A1A1A] dark:text-[#F0ECE1]">Expense Planner</h1>
            {householdMember && (
      ...
      <main className="flex-grow flex flex-col">
        ...
        <div className="block sm:hidden mb-4">
          ...
          <div className="relative">
            ...
            >
              {visibleTabs.map(t => (
                <option key={t.key} value={t.key} className="font-sans not-italic text-sm bg-white dark:bg-[#1A1A1A] text-[#1A1A1A] dark:text-[#F0ECE1]">
                  {t.label}
                </option>
              ))}
            </select>
